...
export default function ThemePage() {
  ...
  const currentSidebarNavKey = location.state?.sidebarNavKey || 'app-design';
        ...
        <PageHeader
          ...
          onBack={() =>
            navigate('/dashboard', {
              state: {
                userName,
                trust: currentTrust || trust,
                sidebarNavKey: currentSidebarNavKey === 'dashboard' ? 'app-design' : currentSidebarNavKey,
              },
            })
          }
